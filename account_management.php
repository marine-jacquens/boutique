...
<body>
	...
	<main>
        ...
        <section class="forme" id="account_management">
            ...
            <table class="table_admin" id="table_account">
            	<thead>
            		<tr><th colspan="14" class="table_title">INFORMATIONS UTILISATEURS</th></tr>
            		<tr>
            	...
            	<tbody>
            		...
            		<tr>
            			...
            			<td class="table_middle"><?php if($user_info['autorisation_rgpd'] == true){?> <i class="fal fa-check"></i> <?php }else{?> <i class="fal fa-times"></i> <?php }    ?></td>
            			<td class="table_middle"><?php if($user_info['autorisation'] == true){?> <i class="fal fa-check"></i> <?php }else{?> <i class="fal fa-times"></i> <?php } ?></td>
            			<td class="table_middle">
                            <!-- CREATION "SOUS PAGE" POUR MODIFIER UNIQUEMENT LA LIGNE CONTENANT L'ID DU PRODUIT -->
                            <a href="account_management.php?user_edit=<?php echo $user_info['id_user'] ?>#edit_management"><i class="fas fa-edit"></i></a>
                        </td>
                        <td class="table_middle">
                        	<?php if(isset($_POST['delete_user'])){$user->delete($_POST['id_user']);} ?>
            	...
            	<?php } $get_info_users->closeCursor(); ?>
            	</tbody>
            </table>
            ...
            <?php 
            	...
            	if(isset($_GET['user_edit'])){
					...
					<form action="" method="post" class="form_admin" id="edit_management">
						...
						<div class="form_admin_body">
							...
							<div class="form_admin_position">
					            ...
					            <div class="gender">
							        ...
							        <input type="radio" name="gender" id="male" value="male" class="input_admin" <?php if($check==true){echo "checked";}else{echo "";}  ?>>
							        <label for="male">Homme</label>

							        <input type="radio" name="gender" id="female" value="female" class="input_admin" <?php if($check2==true){echo "checked";}else{echo "";}  ?>>
							        <label for="female">Femme</label>

							        <input type="radio" name="gender" id="no_gender" value="no_gender" class="input_admin" <?php if($check3==true){echo "checked";}else{echo "";}  ?>>
							        <label for="no_gender">Non genré</label>
					            </div>
					            
								<label for="lastname">Nom de famille</label>
						        <input type="text" name="lastname" placeholder="<?php echo $user_info['lastname'] ?>" class="input_admin">

						        <label for="firstname">Prénom</label>
						        <input type="text" class="input" name="firstname" placeholder="<?php echo $user_info['firstname'] ?>" class="input_admin">

						        <label for="birthday">Date de naissance</label>
						    	<input type="date" name="birthday" value="<?php echo $user_info['birthday'] ?>" class="input_admin">

						    	<label for="phone">N° de téléphone</label>
							    <input type="text" name="phone" placeholder="<?php echo $user_info['phone'] ?>" class="input_admin">
							...
							<div class="form_admin_position">
							    ...
							    <input type="text" name="mail" placeholder="<?php echo $user_info['mail'] ?>" class="input_admin">

							    <label for="account_type">Type de compte</label>
							    <input type="text"  name="account_type" placeholder="<?php echo $user_info['account_type'] ?>" class="input_admin">
							            
							    <label for="password">Nouveau mot de passe</label>
							    <input type="password" name="password" placeholder="Entrez votre mot de passe" class="input_admin">

								<label for="password_check">Confirmation nouveau mot de passe</label>
							    <input type="password" name="password_check" placeholder="Confirmez votre mot de passe" class="input_admin">

								<div>
									<input type="checkbox" id="autorisation_rgpd" name="rgpd" value="<?php if($user_info['autorisation_rgpd'] == true ){echo "denial" ;}else{ echo "autorisation" ; } ?>">
									<label for="autorisation_rgpd"><?php if($user_info['autorisation_rgpd'] == true){echo 'Refuser collecte d\'information (RGPD)';}else{ echo 'Autoriser collecte d\'information (RGPD)';} ?></label>
								</div>

								<div>
									<input type="checkbox" id="autorisation_newsletter" name="newsletter" value="<?php if($user_info['autorisation'] == true){echo "denial" ;}else{ echo "autorisation" ; } ?>">
									<label for="autorisation_newsletter" class="autorisation_newsletter"><?php if($user_info['autorisation'] == true){echo 'Ne plus recevoir la newsletter';}else{ echo 'Autoriser newsletter';} ?></label>
								</div>								
						...
						<div class="button_admin_position"><input type="submit" name="submit_update" value="ENVOYER" class="button_admin"></div>
					</form>
            ...
            <table class="table_admin" id="table_account_wish">
            	<thead>
            		<tr><th colspan="5" class="table_title">LISTE D'ENVIES UTILISATEUR</th></tr>
            		<tr>
            			<th>Id utilisateur</th>
            			<th>Id produit</th>
            			<th>Produit(s)</th>
            	...
            	<tbody>
            		...
            		<tr>
            			...
            			<td><a href="product_page.php?prod=<?php echo $wish_list_info['id_product'] ?>"><?php echo $wish_list_info['product_name'] ?></a></td>
            			<td class="table_middle"><img src="<?php echo $wish_list_info['picture'] ?>" alt="<?php echo $wish_list_info['picture'] ?>" width="70"></td>
            			<td class="table_middle"><?php echo $wish_list_info['time_added'] ?></td>
            		</tr>
            		<?php } $get_wish_list->closeCursor(); ?>
            	</tbody>
            </table>

            <?php if(isset($_POST['definitive_delete'])){ $wish->delete();} ?> 
            ...
            <table class="table_admin" id="table_account_cart">
            	<thead>
            		<tr><th colspan="6" class="table_title">LISTE ARTICLES PANIER UTILISATEUR</th></tr>
            		<tr>
            			<th>Id utilisateur</th>
            			<th>Id produit</th>
            			<th>Produit(s)</th>
            	...
            	<tbody>
            		...
            		<tr>
            			...
            			<td><a href="product_page.php?prod=<?php echo $cart_info['id_product'] ?>"><?php echo $cart_info['product_name'] ?></a></td>
            			<td class="table_middle"><img src="<?php echo $cart_info['picture'] ?>" alt="<?php echo $cart_info['picture'] ?>" width="70">
            			</td>
            			<td class="table_middle"><?php echo $cart_info['quantity'] ?></td>
            			<td class="table_middle"><?php echo $cart_info['time_added'] ?></td>
            		</tr>
            		<?php } $get_cart_list->closeCursor(); ?>
            	</tbody>
            </table>

            <?php if(isset($_POST['definitive_delete_cart'])){ $cart->delete();} ?> 
