    ...
    <main>
        ...
        <section class="products">
            ...
            <div class="products_card">
                <div>
                    <a href="product_page.php?prod=<?php echo $info_products['id_product'] ?>"><img src="<?php echo $info_products['picture'] ?>" width="300" alt="<?php echo $info_products['product_name'] ?>"></a>
                </div>
