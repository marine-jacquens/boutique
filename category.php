...
?>
    ...
    <main>
            ...
            <section class="products">
                <?php foreach ($all_products as $info_products) { ?>
                    <div class="products_card">
                        <div><a href="product_page.php?prod=<?php echo $info_products['id_product'] ?>"> <img src="<?php echo $info_products['picture'] ?>" alt="<?php echo $info_products['product_name'] ?>"></a></div>
                        <div class="info_products">
                            <div class="title_cart">
                                ...
                                if (isset($_SESSION['user']['id_user'])) {
                                    ...
                                    $get_wish_list = $connexion_db->prepare("SELECT * FROM wish_list_items WHERE id_user = ? AND id_product = ? ");
                                    $get_wish_list->execute([$id_user,$id_product]);
                                    ...
                                    if (!empty($wish_list)) {
                                        ...
                                        if ($wish_list['saved_for_later'] == true) {
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <input type="hidden" name="id_product"
                                                       value="<?php echo $info_products['id_product'] ?>">
                                        ...
                                        <?php } //SI L'OPTION SAUVEGARDE A VALEUR FAUX REACTIVER L'ITEM EXISTENT DANS LA WISH LIST
                                        else { ?>
        ...
        <?php } else {
            echo "<h1 class='building_page'>Oops sorry, page en construction...</h1>";
        } ?>
    </main>
    <footer>
