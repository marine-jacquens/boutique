...
class Users
{
            ...
            if (filter_var($mail, FILTER_VALIDATE_EMAIL)) {
                ...
                if ($password == $password_check) {
                    ...
                    if (empty($checked_mail[0])) {
                        ...
                        echo "<span>Ce mail existe déjà</span>";
                    }

                } else {
                    echo "<span>Les champs mot de passe et confirmation de mot de passe doivent être identiques</span>";
                }

            } else {
                echo "<span>Mail non conforme</span>";
            }
    ...
    public function update($lastname, $firstname, $gender, $birthday, $phone, $mail, $password, $password_check, $account_type, $rgpd, $newsletter, $id_user)
    {
        ...
        if (isset($_SESSION['user']['id_user']) and $_SESSION['user']['id_user'] == $id_user) {
            ...
            header("Location:account_management.php#edit_management");
            exit;
        }
