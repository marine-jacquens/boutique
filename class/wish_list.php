...
class WishList
{
    ...
    public function getWishList($id_user)
    {
        ...
        $get_wish_list = $connexion_db->prepare(" 
            SELECT DISTINCT wish_list_items.id_user,wish_list_items.time_added,wish_list_items.id_product,wish_list_items.saved_for_later, products.id_product, products.product_name,products.picture, products.price,product_details.id_product,product_details.color 
            ...
            ORDER BY wish_list_items.time_added DESC");
