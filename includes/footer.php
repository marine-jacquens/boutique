<section class="footer">
    <div class="newsletter_footer">
        <div class="paragraphe_newsletter">
            ...
            <p>
                Inscrivez-vous pour découvrir les nouveautés, vous tenir au courant des dernières tendances et être au
                courant des promotions exclusives.<br><br>Bénéficiez également d’une remise de 10 % sur votre prochaine
                commande.<br><br><span>*</span>Champs obligatoires
            </p>
            <?php
            ...
            <form action="" method="post" class="form_newsletter">
                <div><label for="mail_noSubscriber">Adresse email<span>*</span></label></div>
                <div class="newsletterInput">
                    <input type="email" name="mail_noSubscriber" class="mail_newsletter" id="mail_noSubscriber">
    ...
    <div class="footer_end">
        ...
        <div class="payment_copyright">
            <p>PAIEMENTS SÉCURISÉS STRIPE - POSSIBILITE DE PAIEMENT PAR <i class="fab fa-cc-mastercard"></i> <i
                        class="fab fa-cc-visa"></i></p>
            <p>
                Propulsé par la marque DUPEZ - <a href="#">Copyright © 2020 GROUPE LES SILENCIEUX - Tous droits réservés
                    - Informations au sujet du vendeur</a> - Photographie retouchée
            </p>
        </div>
    </div>
</section>
